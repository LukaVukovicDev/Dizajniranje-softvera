...
{
    // ================================================================
    // DbRepository - Insert/Update/Delete za sve tabele
    // Koristiti: var repo = new DbRepository(connectionString, isMssql);
    // ================================================================
    public class DbRepository
    {
        ...
        public DbRepository(string connectionString, bool isMssql)
        {
        ...
        // ----------------------------------------------------------------
        // Pomocna metoda - kreira konekciju na osnovu tipa baze
        // ----------------------------------------------------------------
        private IDbConnection CreateConnection()
        {
            IDbConnection conn = _isMssql
        ...
        public void DeleteAdmin(int adminId)
        {
            using var conn = CreateConnection();
            using var cmd = conn.CreateCommand();
            cmd.CommandText = "DELETE FROM Admins WHERE AdminID = @AdminID";
            AddParam(cmd, "@AdminID", adminId);
            cmd.ExecuteNonQuery();
        }
        ...
        public void DeleteMembershipType(int id)
        {
            using var conn = CreateConnection();
            using var cmd = conn.CreateCommand();
            cmd.CommandText = "DELETE FROM MembershipTypes WHERE ID = @ID";
            AddParam(cmd, "@ID", id);
            cmd.ExecuteNonQuery();
        }
        ...
        // ================================================================
        // Pomocna metoda za dodavanje parametara (radi za oba tipa baze)
        // ================================================================
